...
const char * const BITCOIN_CONF_FILENAME = "edocash.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Edocash";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Edocash";
#else
    // Unix-like
    return pathRet / ".edocash";
#endif
#endif
}
