...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " edocash-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  edocash-tx [options] <hex-tx> [commands]  Update hex-encoded edocash transaction\n" +
            "or:     edocash-tx [options] -create [commands]   Create hex-encoded edocash transaction\n" +
            "\n";
