...
Please report bugs using the issue tracker at GitHub:
  ...
  <https://github.com/edocash/litecoin/issues>
...
- Four new options are available for configuring the maximum number of
  ...
  documentation](https://github.com/edocash/litecoin/blob/master/doc/zmq.md#usage)
  for details.
...
- A new short [document](https://github.com/edocash/litecoin/blob/master/doc/JSON-RPC-interface.md)
  about the JSON-RPC interface describes cases where the results of an
  RPC might contain inconsistencies between data sourced from different
  subsystems, such as wallet state and mempool state.  A note is added
  to the [REST interface documentation](https://github.com/edocash/litecoin/blob/master/doc/REST-interface.md)
  indicating that the same rules apply.

- Further information is added to the [JSON-RPC
  documentation](https://github.com/edocash/litecoin/blob/master/doc/JSON-RPC-interface.md)
  about how to secure this interface.

- A new [document](https://github.com/edocash/litecoin/blob/master/doc/litecoin-conf.md)
...
- A new document introduces Litecoin Core's BIP174 [Partially-Signed
  ...
  (PSBT)](https://github.com/edocash/litecoin/blob/master/doc/psbt.md)
...
- The [output script
  descriptor](https://github.com/edocash/litecoin/blob/master/doc/descriptors.md)
...
- The minimum required version of Qt (when building the GUI) has been
  ...
  system](https://github.com/edocash/litecoin/blob/master/depends/README.md)
  provides 5.9.7)
...
- `deriveaddresses` returns one or more addresses corresponding to an
  [output descriptor](https://github.com/edocash/litecoin/blob/master/doc/descriptors.md).
...
- `importmulti` now supports importing of addresses from descriptors. A
  ...
  [here](https://github.com/edocash/litecoin/blob/master/doc/descriptors.md).
...
- The 'account' API is removed after being deprecated in v0.17.  The
  ...
  v0.17](https://github.com/edocash/litecoin/blob/master/doc/release-notes/release-notes-0.17.0.md#label-and-account-apis-for-wallet)
