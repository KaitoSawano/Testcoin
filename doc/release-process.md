...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/edocash/gitian.sigs.ltc.git
    git clone https://github.com/edocash/litecoin-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/edocash/litecoin.git
...
- Detached signatures will then be committed to the [litecoin-detached-sigs](https://github.com/edocash/litecoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/edocash/litecoin/releases/new) with a link to the archived release notes.
