...
"""Verify that starting edocash with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start edocash with -h for help text")
        ...
        self.log.info("Start edocash with -version for version information")
        ...
        self.log.info("Start edocashd with -fakearg to make sure it does not start")
