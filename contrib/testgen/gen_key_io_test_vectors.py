...
bech32_templates = [
  ...
  ('edoc',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('edoc',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('edoc',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('edoc',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tedoc',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tedoc',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tedoc',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tedoc',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tedoc',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tedoc',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tedoc',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tedoc',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('redoc',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('redoc',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('redoc',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('redoc', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tedoc',   17, 32, Encoding.BECH32M, False, False, False),
  ('redoc',  3,  1, Encoding.BECH32M, False, False, False),
  ('edoc',   15, 41, Encoding.BECH32M, False, False, False),
  ('tedoc',    0, 16, Encoding.BECH32,  False, False, False),
  ('redoc',  0, 32, Encoding.BECH32,  True,  False, False),
  ('edoc',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tedoc',    0, 32, Encoding.BECH32,  False, True,  False),
  ('redoc',  0, 20, Encoding.BECH32,  False, False, True),
  ('edoc',    0, 20, Encoding.BECH32M, False, False, False),
  ('tedoc',    0, 32, Encoding.BECH32M, False, False, False),
  ('redoc',  0, 20, Encoding.BECH32M, False, False, False),
  ('edoc',    1, 32, Encoding.BECH32,  False, False, False),
  ('tedoc',    2, 16, Encoding.BECH32,  False, False, False),
  ('redoc', 16, 20, Encoding.BECH32,  False, False, False),
]
